...
@section('title', 'News & Events - Department of Computer Science')
...
<div class="container">
    <!-- Simple test to confirm view is loading -->
    <div style="background: #ffc107; color: #1a2b3c; padding: 1rem; margin-bottom: 2rem; border-radius: 5px;">
        <strong>Debug:</strong> View is loading! News count: {{ $news->count() ?? 0 }}
    </div>
